...
export function PrecisionConsent({
  ...
  if (!available) {
    return (
      <section className="min-w-0 rounded-sm border border-rule bg-surface px-3 py-2.5">
        <p className="text-[12px] font-semibold text-ink">이 기기 안에서만 분석합니다</p>
  ...
  return (
    <section className="min-w-0 rounded-sm border border-rule bg-canvas px-3 py-2.5">
      <label htmlFor={checkboxId} className="flex cursor-pointer items-start gap-2.5">
        ...
        <span className="min-w-0">
          ...
          <span id={hintId} className="mt-0.5 block text-[12px] leading-relaxed text-ink-muted">
      ...
      <Disclosure summary="무엇이 전송되나요?" className="mt-2 min-w-0">
        <div className="space-y-2">
          <div className="min-w-0">
            <p className="text-[11px] font-bold text-ink">보내는 것</p>
            <ul className="mt-0.5 space-y-0.5 text-[12px] leading-snug text-ink-muted">
          ...
          <div className="min-w-0">
            <p className="text-[11px] font-bold text-ink">보내지 않는 것</p>
            <ul className="mt-0.5 space-y-0.5 text-[12px] leading-snug text-ink-muted">
